...
;(function ( $, window, document, undefined ) {
  ...
  defaults = {
    ...
    buttons: {  //settings for buttons
      ...
      love: { ////pinterest.com/about/goodies/
        url: '',  //if you need to personalize url button
        media: '',
        description: '',
        layout: 'horizontal'
  ...
  urlJson = {
    ...
    love: simple_love.ajaxurl + '?action=genesis_simple_love&data=getCount&nonce=' + simple_love.nonce +'&data_url={url}',
  },
  ...
  loadButton = {
    ...
    love : function(self){
      var sett = self.options.buttons.love;
      $(self.element).find('.buttons').append('<div class="button love"><a href="#" class="love-it-button" data-count="'+ sett.count +'" data-counter="'+sett.counter+'" count-layout="'+sett.layout+'">'+ simple_love.ajaxurl +'</a></div>');
    }
  },
  ...
  popup = {
    ...
    love: function(opt){
      $.ajax({
        ...
        data : {action: "genesis_simple_love", data_url : opt.url, nonce: simple_love.nonce},
        success: function(response){
          if(response.type == 'error'){
            // console.log( response.id );
            $('#love-before-' + response.id + ' .count , #love-after-2' + response.id + ' .count').html( response.count );
          }
